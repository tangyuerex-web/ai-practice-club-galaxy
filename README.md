...
The cover includes two galaxy forms: the original spiral galaxy and a uniformly sampled spherical shell. Both forms support five particle-density levels: 5K, 10K, 20K, 35K, and 50K. The default is 20K. Controls are index movement, a forward index tap for a supernova, open-palm horizontal movement for unlimited 3D rotation, and slow hand opening/closing for radial expansion or contraction. The index target is a coordinate marker only and does not attract nearby particles.
